...
PURPOSE:
  ...
  The PowerBinning makes use of the algorithm from Cappellari & Copin 2003
...
def generateSpatialBins(config, cube):
    ...
    # Handle common exceptions
        ...
        if str(e) == "All pixels have enough S/N and binning is not needed":
            ...
            logging.warning(
                "Defining the Power bins failed. The PowerBinning routine of Cappellari & Copin "
        ...
        # Any uncaught exceptions, causing the galaxy to be skipped
            ...
            print(
                "The PowerBinning routine of Cappellari & Copin (2003) returned the following error: \n"
                + str(e)
            )
            logging.error(
                "Defining the Power bins failed. The PowerBinning routine of Cappellari & Copin "
